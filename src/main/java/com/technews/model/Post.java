...
public class Post implements Serializable {
    ...
    // @NotNull signals to Spring Data JPA that this variable is not to be allowed to be null in the database.
    // @Temporal allows us to use the Date type in the database
    // @Column(name = "name_here") designates the name for the database.
    @NotNull
